        ...
        child: ListView(
          ...
          children: [
            ...
            Container(
              ...
              child: TextFrave(text: 'Which NFT You Want Today?', fontSize: 28, maxLine: 2, fontWeight: FontWeight.w500 )
            ),
            SizedBox(height: 20.0),
            Row(
              children: [
                      ...
                      children: [
                        Container(
                          child: Hero(
                            ...
                            child: Image.network('http://192.168.1.69:7070/' + listProduct[i].picture , height: 150)
                          ),
                        ),
